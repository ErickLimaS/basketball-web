...
import StatisticsPlayer from '../../components/Home/YesterdayHighlights/StatisticsPlayer/StatisticsPlayer'
...
export default function FinishedGame({ item }) {
    ...
    const GamesFinished = async (gameId) => {
    ...
    return (
        ...
        <div className='game-statistics' id={gameId} >
            <C.Container>
                <div className='section-map'>
                    <div className='score-and-teams'>
                        <div className='flex-2 team'>
                            ...
                            <Link to={`/team/${item.home_team.id}`}>
                        ...
                        <div className='flex-2 inverse team'>
                            ...
                            <Link to={`/team/${item.visitor_team.id}`}>
